...
export async function searchAppleMusic(isrc, developerToken) {
  try {
...
export async function createApplePlaylist(name, description, trackIds, developerToken, musicUserToken) {
  try {
